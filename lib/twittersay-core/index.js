 ...
 */
 var harvester = function(conf) {
  ...
  function resetCounter() {
    this.redis.get('twittersay-core-word-last-minute', function(err, cnt){
      this.redis.set('twittersay-core-word-per-minute', cnt);
      this.redis.set('twittersay-core-word-last-minute', 0);
    });
  };
  setInterval(harv.resetCounter, 60 * 1000);
